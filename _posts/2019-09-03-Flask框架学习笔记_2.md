...
* 模板基本语法：
  ...
  ![](C:\Users\acer\Documents\GitHub\FXHao.github.io\images\posts\Flask\图片9.png)
...
* 在 **Flask** 中，模板变量可以进行加减运算的
  ...
  ![](C:\Users\acer\Documents\GitHub\FXHao.github.io\images\posts\Flask\图片10.png)
...
* 模板文件中
  ...
  ![](C:\Users\acer\Documents\GitHub\FXHao.github.io\images\posts\Flask\图片11.png)
...
* 它的功能是将另一个模板整个加载到当前模板中，并直接渲染
  ...
  ![](C:\Users\acer\Documents\GitHub\FXHao.github.io\images\posts\Flask\图片7.png)
* 如该模板文件不存在，则会抛出异常，加上 `ignore missing`时，则会忽略包含语句
  
  ![](C:\Users\acer\Documents\GitHub\FXHao.github.io\images\posts\Flask\图片8.png)
