...
![静态数码管原理图](E:\图片\github图片\静态数码管原理图.png)
...
![动态数码管原理图](E:\图片\github图片\动态数码管原理图.jpg)
...
![](E:\图片\github图片\消影后.jpg)

都正常显示，除数值外的数码管段位都是灭的

##### 无消影

![](E:\图片\github图片\无消影.jpg)
